...
namespace GCGetGenerationWeakExample
{
    public class MyGCCollectClass
    {
        ...
        static void Main()
        {
            ...
            Console.WriteLine(GC.GetGeneration(p.Child));
            ...
            //Console.WriteLine(GC.GetGeneration(p));
            //Console.WriteLine(GC.GetGeneration(p.Name));

            //double[] arr1 = new double[999]; //SOH
            //double[] arr2 = new double[10999]; //LOH
            //Console.WriteLine(GC.GetGeneration(arr1));
            //Console.WriteLine(GC.GetGeneration(arr2));



            #region MyGCCollectClass
            /*
